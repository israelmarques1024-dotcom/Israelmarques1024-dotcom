...
// @version      2.7.0
// @description  Assistente conceitual de estudo com suporte a alternativas, Certo/Errado, lacunas e respostas abertas.
...
const PARTS=5;
const EXPECTED='9d14f58f238994ae6a83934f0662b5591eca3349fbb7c9cb08349ed6c3e6d9be';
const CACHE='doritus_ultra_bundle_v27';
...
try{
  ...
  if(!source){console.error('[Doritus Ultra] Não foi possível carregar v2.7:',err);return;}
}
